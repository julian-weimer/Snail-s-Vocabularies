...
Let's refine a word list in a JSON file.
...
Add the `plural_form` key with the plural form of the noun if $language_name is one of these languages:
- catalan
- danish
- dutch
- english
...
Add these keys including the corresponding word or expression. It should be applicable to all languages, but you can skip them if $language_name doesn't have a way to express them:
- `positive`
- `comparative`
- `superlative`
