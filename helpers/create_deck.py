...
def create_deck(
    ...
    for word_object in word_objects:
        ...
        comment_object = word_object.get("comment", {})
        ...
        image_filepath = os.path.join(images_dir, f"{key}.jpg")
        ...
        image_source_snippet = get_image_source(key, images_dir)
        ...
        # Get comment for native language
        comment_text = comment_object.get(native_language.value, "")
